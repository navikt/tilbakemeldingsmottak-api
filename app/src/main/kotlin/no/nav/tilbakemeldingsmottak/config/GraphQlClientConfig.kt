...
class GraphQlClientConfig(
    ...
    fun pdlWebClient(
        //@Qualifier("pdlAuthMng") oauth2Filter: ServletOAuth2AuthorizedClientExchangeFilterFunction,
        authorizedClientManager: OAuth2AuthorizedClientManager,
    ...
    fun safWebClient(
        //@Qualifier("safAuthMng") oauth2Filter: ServletOAuth2AuthorizedClientExchangeFilterFunction,
        authorizedClientManager: OAuth2AuthorizedClientManager,
        clientRegistrationRepository: ClientRegistrationRepository
    ): WebClient {
    ...
    private fun oauth2ExchangeFilter(
        ...
        return ExchangeFilterFunction { request, next ->
            ...
            val principalString: String? // non-null hvis vi skal bruke String-overloaden
            val principalAuth: Authentication? // non-null hvis vi skal bruke Authentication-overloaden
